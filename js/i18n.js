...
const TRANSLATIONS = {
  it: {
    ...
    pages: {
      ...
      social: {
        ...
        metaDesc: 'Segui The Little Satoshi News su Facebook, Instagram, TikTok e YouTube. Guide crypto semplici ogni giorno.',
  ...
  en: {
    ...
    pages: {
      ...
      social: {
        metaTitle: 'Social — The Little Satoshi News',
        metaDesc: 'Follow The Little Satoshi News on Facebook, Instagram, TikTok and YouTube. Simple crypto guides every day.',
