...
const TRANSLATIONS = {
  it: {
    ...
    btcNews: {
      ...
      homeDesc: 'Ultime notizie da @BitcoinMagazine, @Strategy e @CPOfficialtx nella sessione dedicata.',
      filterAll: 'Tutte',
      openOnX: 'Apri su X',
  ...
  en: {
    ...
    btcNews: {
      ...
      homeDesc: 'Latest posts from @BitcoinMagazine, @Strategy and @CPOfficialtx in a dedicated session.',
      filterAll: 'All',
      openOnX: 'Open on X',
