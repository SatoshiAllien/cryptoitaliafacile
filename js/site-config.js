const SITE_CONFIG = {
  ...
  year: 2026,
  assetVersion: '20260703-hero-clean',
  email: 'info@cryptofacile.com',

  founder: {
    fullName: 'Stefano Davide Ciancimino',
    shortName: 'Stefano',
    title: 'Fondatore di CryptoItaliaFacile',
  ...
  categories: [
    ...
    { id: 'bitcoin', label: 'Bitcoin', href: 'bitcoin/index.html', color: '#F7931A', bg: 'rgba(247,147,26,0.1)' },
    { id: 'ethereum', label: 'Ethereum', href: 'ethereum/index.html', color: '#627EEA', bg: 'rgba(98,126,234,0.1)' },
    { id: 'smart-contract', label: 'Smart Contract', abbr: 'SC', href: 'smart-contract/index.html', color: '#10B981', bg: 'rgba(16,185,129,0.1)' },
    { id: 'cardano', label: 'Cardano', href: 'cardano/index.html', color: '#3b82f6', bg: 'rgba(59,130,246,0.08)' },
